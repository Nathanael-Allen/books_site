    ...
    readingList.forEach((book)=>{
        let div = /*html*/`
            <div class="bg-gray-800 flex items-center w-full my-4 p-2 rounded-lg max-sm:flex-col" >
                ...
                <button hx-get="/books/reviews/add/${book['BOOKID']}" hx-target="#main-div" class="text-white p-2 flex bg-sky-500 items-center rounded-lg hover:bg-sky-800 sm:ml-auto max-sm:mt-4"> 
